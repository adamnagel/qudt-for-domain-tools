...
qudt4dt.thrift.Qudt4dt_base_unitExp_args = function(args) {
  this.exp = null;
  this.dstUnit = null;
  if (args) {
    ...
    if (args.dstUnit !== undefined) {
      this.dstUnit = args.dstUnit;
    }
  }
};
qudt4dt.thrift.Qudt4dt_base_unitExp_args.prototype = {};
qudt4dt.thrift.Qudt4dt_base_unitExp_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.exp = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.dstUnit = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
qudt4dt.thrift.Qudt4dt_base_unitExp_args.prototype.write = function(output) {
  output.writeStructBegin('Qudt4dt_base_unitExp_args');
  if (this.exp !== null && this.exp !== undefined) {
    output.writeFieldBegin('exp', Thrift.Type.STRING, 1);
    output.writeString(this.exp);
    output.writeFieldEnd();
  }
  if (this.dstUnit !== null && this.dstUnit !== undefined) {
    output.writeFieldBegin('dstUnit', Thrift.Type.STRING, 2);
    output.writeString(this.dstUnit);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
qudt4dt.thrift.Qudt4dt_base_unitExp_result = function(args) {
  this.success = null;
  this.err = null;
  if (args instanceof qudt4dt.thrift.InvalidOperation) {
    this.err = args;
...
qudt4dt.thrift.Qudt4dt_base_unitExp_result.prototype = {};
qudt4dt.thrift.Qudt4dt_base_unitExp_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
qudt4dt.thrift.Qudt4dt_base_unitExp_result.prototype.write = function(output) {
  output.writeStructBegin('Qudt4dt_base_unitExp_result');
  if (this.success !== null && this.success !== undefined) {
...
qudt4dt.thrift.Qudt4dt_baseClient.prototype.unitExp = function(exp, dstUnit, callback) {
  this.send_unitExp(exp, dstUnit, callback); 
  if (!callback) {
    return this.recv_unitExp();
  }
};

qudt4dt.thrift.Qudt4dt_baseClient.prototype.send_unitExp = function(exp, dstUnit, callback) {
  this.output.writeMessageBegin('unitExp', Thrift.MessageType.CALL, this.seqid);
  var args = new qudt4dt.thrift.Qudt4dt_base_unitExp_args();
  args.exp = exp;
  args.dstUnit = dstUnit;
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
...
qudt4dt.thrift.Qudt4dt_baseClient.prototype.recv_unitExp = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  var result = new qudt4dt.thrift.Qudt4dt_base_unitExp_result();
  result.read(this.input);
  this.input.readMessageEnd();
  ...
  throw 'unitExp failed: unknown result';
};
