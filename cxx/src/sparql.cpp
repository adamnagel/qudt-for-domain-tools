...
void init_server(const string& server_url)
{
    sparql::_su.url_base = server_url;
    sparql::_su.url_upload = server_url + "/qudt4dt/upload";
    sparql::_su.url_query = server_url + "/qudt4dt/query?";
    sparql::_su.url_update = server_url + "/qudt4dt/update?";
};
